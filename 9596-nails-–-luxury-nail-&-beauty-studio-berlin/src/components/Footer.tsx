    ...
    <footer className="bg-gradient-to-b from-[#FFF5F9] via-[#FFEDF4] to-[#FFE7F1] pt-16 pb-8 border-t border-[#F7DBE6]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-16 border-b border-[#F7D4E3]">
          ...
          <div className="md:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h3 className="text-xl font-serif font-bold text-[#29181E]">9596 Nails</h3>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs sm:text-sm text-[#644B55] pt-2">
              ...
              <a href="#our-work" className="hover:text-[#D14F84] transition-colors py-1 font-semibold text-[#D14F84]">
                {t.nav.ourWork} ✨
              </a>
            ...
            <div className="pt-3 flex items-center gap-3">
              ...
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.29 0 .58.04.86.12V9.42a6.34 6.34 0 0 0-.86-.06 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34-6.34V8.52a8.27 8.27 0 0 0 5.07 1.76V6.85a4.85 4.85 0 0 1-1.3-.16z"/>
                </svg>
              </a>
              <a
          ...
          <div className="md:col-span-4 space-y-2 text-xs text-[#6B505A]">
            ...
            <p className="font-semibold text-sm text-[#29181E]">9596 Nails &amp; Beauty</p>
            <p>Frankfurter Allee / Boxhagener Kiez</p>
            <p>10247 Berlin, Deutschland</p>
            <p className="pt-2 text-[#906B7A]">Mo–Fr: 09:30 – 19:00 Uhr</p>
            <p className="text-[#906B7A]">Sa: 10:00 – 17:00 Uhr · So: Geschlossen</p>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            {!subscribed ? (
              ...
              <div className="flex items-center gap-2 text-xs font-medium text-[#1E7138] bg-[#EBF7EE] p-3 rounded-xl border border-[#CCE8D4]">
                ...
                <span>{lang === 'de' ? 'Vielen Dank für deine Anmeldung!' : 'Thank you for subscribing!'}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-[#F7D4E3] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#8C6B79]">
          <p>© {new Date().getFullYear()} 9596 Nails &amp; Beauty Berlin. All Rights Reserved.</p>
